...
import { FeaturedProductCardProps, Product } from "../types";
...
const FeaturedProductCard = ({
  ...
  return (
    <div
      ...
      className="shadow-md p-3 relative transition-all duration-300 hover:bg-gray-50 hover:shadow-md cursor-pointer h-auto flex flex-col rounded-md min-h-[20rem]"
    >
      {product.isPromoted && (
      ...
      <h2 className="text-xs sm:text-sm font-semibold mb-1">
        {truncateText(product.title.toUpperCase(), 30)}
      </h2>
