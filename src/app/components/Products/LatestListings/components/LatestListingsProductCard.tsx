...
const LatestListingsProductCard = ({
  ...
  return (
    <div
      ...
      className="shadow-md p-3 relative transition-all duration-300 hover:bg-gray-50 hover:shadow-md cursor-pointer h-auto flex flex-col rounded-md min-h-[22rem]"
    >
      ...
      <div className="mt-auto">
        ...
        <p
          className="text-orange-500 font-bold truncate"
        >
